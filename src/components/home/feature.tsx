      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            Build your mobile app without coding. Customize your design with our easy-to-use templates and launch your app in minutes with our app builder web app. Get started today and create your app without the hassle.
            </Typography>
